...
enyo.kind({
    ...
    toggleMenu: function(inSender, ionOriginator, secondary) {
        ...
        this.$.menu.applyStyle("z-index", "999");
        this.$.menu.applyStyle("transform","translateZ(0) translateX(143%)");
        this.$.menu.applyStyle("transition-duration","0.5s");
    },
    ...
    menuTapHandler: function(inSender, inEvent) {        
        ...
        if (view) {
            if (this.getView() == view) {
                ...
                this.$.pane.$.animator.setDuration(0);
    ...
    viewChanged: function(oldView) {
        this.$.menu.applyStyle("z-index", "0");
        this.$.menu.applyStyle("transform","translateZ(0) translateX(0%)");
        this.$.menu.applyStyle("transition-duration","0.6s");
    ...
    paneAnimateFinishHandler: function(inSender) {
        ...
        if (Math.abs(value) == 100) {
            ...
            setTimeout(enyo.bind(this, function() {
                this.$.pane.$.animator.setDuration(400);
